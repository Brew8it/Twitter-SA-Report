...
\opponent{Vidar Tengstål, Sigrid Österling Sicking}
...
Kapitel 2 presenterar studiens syfte och vilka klassificeringsalgoritmer samt datamängder som studien kommer använda. Kapitlet introducerar även viktiga begrepp och metoder som används i studien.
...
Övervakad inlärning kan beskrivas som att en lärare övervakar programmets inlärningsprocess. Under inlärningsprocessen försöker algoritmen iterativt förutse utdata från datamängden och blir rättad av läraren vid fel förutsägelse \cite{learning:001}.
