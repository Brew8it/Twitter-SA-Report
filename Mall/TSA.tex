...
Användargenererat innehåll är en bra källa för åsikter och kan användas för att tolka och förstå allmänhetens åsikter i olika frågor \cite{TSAsurvey}. Företag kan exempelvis använda användargenererat innehåll för att ta reda på vad kunder har för åsikter om företagets egna eller konkurrenters produkter. Informationen kan de sedan använda för att förbättra sina produkter. 
