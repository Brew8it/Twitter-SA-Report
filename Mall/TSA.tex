...
\centering
\caption{Illustrerar webb gränssnittets sökformulär.}
\label{fig:dataset}
\end{figure}
...
\centering
\caption{Illustrerar hur klassificeringsmodellerna har klassificerat 10 stycken twitterinlägg från användaren “realDonaldTrump”.}
\label{fig:dataset}
\end{figure}
