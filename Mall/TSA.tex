...
\label{tab:lexi_se}
    ...
    \midrule
    \textbf{Totalt genomsnitt} & 0.682 & 0.671 & 0.676  & 2058 \\
    \bottomrule
\end{tabular}
\end{table}
\subsection{Naive Bayes}
...
\label{tab:nb_base_se}
    ...
    \midrule
    \textbf{Totalt genomsnitt} & 0.854 & 0.857 & 0.852  & 2058 \\
    \bottomrule
\end{tabular}
\end{table}
...
\label{tab:nb_imp_se}
    ...
    \midrule
    \textbf{Totalt genomsnitt} & 0.850 & 0.853 & 0.849  & 2058 \\
    \bottomrule
\end{tabular}
\end{table}
...
\label{tab:svm_base_se}
    ...
    \midrule
    \textbf{Totalt genomsnitt} & 0.849 & 0.848 & 0.849  & 2058 \\
    \bottomrule
\end{tabular}
\end{table}
...
\label{tab:svm_imp_se}
    ...
    \midrule
    \textbf{Totalt genomsnitt} & 0.871 & 0.871 & 0.865  & 2058 \\
    \bottomrule
\end{tabular}
\end{table}
...
\label{tab:cnn_se}
    ...
    \midrule
    \textbf{Totalt genomsnitt} & 0.865 & 0.867 & 0.865  & 2058 \\
    \bottomrule
\end{tabular}
\end{table}
...
\label{tab:lexi_sts}
    ...
    \midrule
    \textbf{Totalt genomsnitt} & 0.596 & 0.585 & 0.573  & 320000 \\
    \bottomrule
\end{tabular}
\end{table}
...
\label{tab:nb_base_sts}
    ...
    \midrule
    \textbf{Totalt genomsnitt} & 0.771 & 0.771 & 0.771  & 320000 \\
    \bottomrule
\end{tabular}
\end{table}
...
\label{tab:nb_imp_sts}
    ...
    \midrule
    \textbf{Totalt genomsnitt} & 0.792 & 0.790 & 0.789  & 318769 \\
    \bottomrule
\end{tabular}
\end{table}
...
\label{tab:svm_base_sts}
    ...
    \midrule
    \textbf{Totalt genomsnitt} & 0.777 & 0.775 & 0.775  & 320000 \\
    \bottomrule
\end{tabular}
\end{table}

I tabell \ref{tab:nb_grid_sts} presenteras de parametrar som blivit framtagna m.h.a parametersökningen som kodavsnitt \ref{svm:grid} kör på STS-datamängden. Med de framtagna parametrarna har den andra SVM modellen tagits fram. 

\begin{table}[H]
\centering
\caption{Resultat av parametersökning för NB på STS.}
...
\label{tab:svm_imp_sts}
    ...
    \midrule
    \textbf{Totalt genomsnitt} & 0.786 & 0.784 & 0.784  & 320000 \\
    \bottomrule
\end{tabular}
\end{table}
...
\label{tab:cnn_sts}
    ...
    \midrule
    \textbf{Totalt genomsnitt} & 0.804 & 0.804 & 0.804  & 318769 \\
    \bottomrule
\end{tabular}
\end{table}
...
\label{tab:clf_sum}
    ...
    \midrule
    NB med standard parametrar & 85.2\% & NB med optimala parametrar & 78.9\% \\
    SVM med optimala parametrar & 86.5\% & SVM med optimala parametrar & 78.4\% \\
    CNN med optimala parametrar & 86.5\% & CNN med optimala parametrar & 80.4\% \\
    \bottomrule
\end{tabular}
\end{table}
...
\label{tab:clf_train_time}
    ...
    \multicolumn{2}{c}{\textbf{SemEval}} & \multicolumn{2}{c}{\textbf{STS}} \\
    \midrule
    \textbf{Modell} & \textbf{Träningstid} & \textbf{Modell} & \textbf{Träningstid}\\
    \midrule
    NB med optimala parametrar & 201 ms & NB med standard parametrar & 3 min 29 s  \\
    SVM med optimala parametrar & 4 s  & SVM med optimala parametrar & 7 min 59 s  \\
    CNN med optimala parametrar & 1 min 44 s & CNN med optimala parametrar & 173 min \\
    \bottomrule
\end{tabular}
\end{table}
