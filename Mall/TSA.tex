...
STS-datamängden består av 1,6 miljoner twitterinlägg och är framtagen mellan april 2009 och juni 2009 av Alec Go, Richa Bhayani och Lei Huang  \cite{sts:001}. STS-datamängden är märkt med hjälp av ''distant supervision'' där märkningen bestäms av vilken typ av emoji \cite{wiki:010} ett twitterinlägg innehåller, exempelvis märks ett twitterinlägg positivt om det innehåller “:), :-),: ), :D, =)” och negativt om det innehåller “:(, :-(, : (“. 
